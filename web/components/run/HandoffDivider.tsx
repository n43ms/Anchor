...
export function HandoffDivider({
  ...
  return (
    <div className="relative my-3.5 flex items-center justify-center gap-3" data-testid="handoff-divider">
      ...
      <div className="flex items-center gap-2 rounded-xl border border-emerald-500/30 bg-black/85 px-3.5 py-1.5 text-xs font-mono backdrop-blur-xl shadow-md transition-all">
        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 shadow-sm">
