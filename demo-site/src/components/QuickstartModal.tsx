...
services:
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md font-mono select-none transition-opacity duration-200 ${
        isClosing ? "opacity-0 pointer-events-none" : "opacity-100"
      }`}
      onClick={handleClose}
    >
      <div
        className={`relative w-full max-w-6xl flex flex-col rounded-2xl border border-white/10 bg-zinc-950 p-4 sm:p-5 shadow-2xl space-y-3.5 my-auto overflow-hidden transition-all duration-200 ${
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-2.5 shrink-0">
          ...
          <button
            type="button"
            onClick={handleClose}
            className="flex h-7 w-7 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-zinc-400 hover:text-white hover:bg-white/10 transition-all cursor-pointer"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="space-y-3 overflow-hidden flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 shrink-0">
            {/* Step 1 */}
            <div className="rounded-xl border-2 border-amber-500/50 bg-gradient-to-b from-amber-500/15 via-black/90 to-black/90 p-3 space-y-1 shadow-xl relative">
            ...
            {/* Step 2 */}
            <div className="rounded-xl border-2 border-emerald-500/50 bg-gradient-to-b from-emerald-500/15 via-black/90 to-black/90 p-3 space-y-1 shadow-xl relative">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
            ...
            {/* Step 3 */}
            <div className="rounded-xl border-2 border-blue-500/50 bg-gradient-to-b from-blue-500/15 via-black/90 to-black/90 p-3 space-y-1 shadow-xl relative">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
            ...
            <div className="rounded-xl border-2 border-purple-500/50 bg-gradient-to-b from-purple-500/15 via-black/90 to-black/90 p-3 space-y-1 shadow-xl relative">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 shrink-0">
            ...
            <div className="rounded-xl border border-white/10 bg-black shadow-xl overflow-hidden flex flex-col h-[390px]">
        ...
        <div className="flex items-center justify-end pt-2 border-t border-white/10 shrink-0">
          <button
            type="button"
            onClick={handleClose}
            className="rounded-xl border border-amber-500/40 bg-amber-500/20 px-5 py-1 text-xs font-bold text-amber-300 hover:bg-amber-500/30 transition-all cursor-pointer"
          >
            Close Guide
          </button>
        </div>
