  ...
  segments: [
    {
      ...
      steps: [
        {
          ...
          duration_ms: 800,
          idempotency_key: "r101:s0:analyze:a1b2",
        ...
        },
        {
          ...
          duration_ms: 1600,
          idempotency_key: "r101:s1:migrate:e5f6",
      ...
      log: [
        ...
        { timestamp: new Date(Date.now() - 13200).toISOString(), text: "Step 0 (LLM Model) complete: analyze_requirements", level: "success" },
        { timestamp: new Date(Date.now() - 11500).toISOString(), text: "Step 1 (Tool Call) complete: execute_db_migration", level: "success" },
        { timestamp: new Date(Date.now() - 6000).toISOString(), text: "⚡ WORKER SWAP: worker-a#1 terminated via SIGKILL", level: "warning" },
      ],
    },
    {
      ...
      log: [
        ...
        { timestamp: new Date(Date.now() - 2100).toISOString(), text: "Step 2 (Tool Call) replayed (skipped side-effect)", level: "info" },
        { timestamp: new Date(Date.now() - 500).toISOString(), text: "Step 3 (LLM Model) complete: synthesize_response", level: "success" },
      ],
    },
  ],
  fencing_events: [
